...
experiment_name=${EXPERIMENT_NAME:-qwen2.5_3b_sft_wireless_grponew}
...
TRAINER=(
    ...
    trainer.default_local_dir=checkpoints/qwen_3b_sft_wireless_grponew
)
